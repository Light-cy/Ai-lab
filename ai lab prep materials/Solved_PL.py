...
# final = Implies(P, res1)
# final2 = Not(final)
# final2.printValidity()
# final.print_truth_table()

final=Implies(P, Or(P,Q))
final.print_truth_table()
